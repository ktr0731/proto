...
func TestEncode(t *testing.T) {
	...
	wantBytes := marshal(t, msg)

	gotBytes, err := Encode(msg)
	if err != nil {
		t.Fatalf("failed to Decode: %s", err)
	}

	var want, got testpb.Message
	unmarshal(t, wantBytes, &want)
	unmarshal(t, gotBytes, &got)
...
func unmarshal(t *testing.T, b []byte, m proto.Message) {
	t.Helper()
